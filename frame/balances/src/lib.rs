...
pub mod pallet {
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		pub fn set_limit(
			...
			Self::deposit_event(Event::LimitChanged(sender.clone(), limit_info.clone()));
			Ok(().into())
		}
	...
	pub enum Event<T: Config<I>, I: 'static = ()> {
		...
		LimitChanged(T::AccountId, AccountLimit<T::Balance, T::Balance, T::Balance>),
	}
	...
	/// Storage Limits info
	#[pallet::storage]
	#[pallet::getter(fn transfer_info)]
	pub type TransferInfo<T: Config<I>, I: 'static = ()> = StorageMap<
		_,
		Blake2_128Concat,
		T::AccountId,
